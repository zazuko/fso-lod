...
curl -H "Accept: application/n-triples" --data-urlencode query@construct/map_municipality2classes_hack.sparql http://localhost:3030/bfs/sparql -o out/map_municipality2classes_hack.nt
