...
curl -X PUT  -u admin:cinderella -d @target/complete.nt -H "Content-Type: application/n-triples" http://admin:cinderella@$FUSEKI_HOST:3030/fso/data --data-urlencode graph=http://example.com/fso
